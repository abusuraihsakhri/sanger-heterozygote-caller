"""
FastAPI REST API Server for Sanger Heterozygote Caller.
"""
...
app = FastAPI(
    title="Sanger Heterozygote Caller API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "sanger-heterozygote-caller", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
