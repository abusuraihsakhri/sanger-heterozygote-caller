"""
Autonomous Bayesian Calibration & Active Learning Feedback Engine for sanger-heterozygote-caller.
"""
import math
...
class ActiveLearningEngine:
    ...
    def __init__(self, system_name: str = "Sanger Heterozygote Caller"):
