"""
Live WebSocket Distributed Component Telemetry Streamer for sanger-heterozygote-caller.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "sanger-heterozygote-caller", "event_type": event_type, "payload": data})
