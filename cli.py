"""
Command Line Interface for Sanger Heterozygote Caller.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="sanger-heterozygote-caller", description="Sanger Heterozygote Caller")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  SANGER HETEROZYGOTE CALLER")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Sanger Heterozygote Caller Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Sanger Heterozygote Caller API server on http://{args.host}:{args.port}")
