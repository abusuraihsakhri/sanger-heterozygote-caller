"""
Automated Pytest for sanger-heterozygote-caller Enrichment Modules.
"""
import sys
...
from enrichment import (
    BatchHeterozygoteScreeningEngine,
    VariantCatalogOutputVcfEngine,
    ChromatogramOverlayVisualizationEngine,
    MultitraceConsensusEngine,
    QualityScoreIntegrationEngine,
    PrimerWalkingAutomationEngine,
    ExportFormatsEngine,
    RestApiServerEngine,
    SangerheterozygotecallerEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = SangerheterozygotecallerEnrichmentSuite()
